...
@router.post("/detect", response_model=PredictionPublic)
...
@router.post("/refresh-classify-model", response_model=ModelRefreshPublic)
...
@router.post("/refresh-detect-model", response_model=ModelRefreshPublic)
